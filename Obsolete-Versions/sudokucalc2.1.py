...
#Generate guesses for each cell (re-use module)
    #If any cell has only one guess, update known list. Repeat guessing module and DONT CONTINUE
    #BETA Guess - later
...
guess_Grid = generate_Guess (known_Values)
for row in guess_Grid:
    for y in row:
        #print ("TESTING ITEM" + str(y))
